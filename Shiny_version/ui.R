...
ui <- navbarPage(title = "Bias in Climate Change",
                 ...
                 fluidPage(
                   ...
                   "The visualization below is a heatmap comparing how frquently a climate change related key word is used in
                 ...
                 navbarMenu("Alaska",
                            ...
                            tabPanel("State trends",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                            ...
                                                            fluidPage(
                                                              div(span(img(src = 'AK_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                              br(), br(),
                                                              div(span(img(src = 'AK_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                              div(span(img(src = 'AK_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                              div(span(img(src = 'AK_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                              div(span(img(src = 'AK_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                              br(), br(),
                                                              div(span(img(src = 'AK_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                              br(), br(),
                                                              div(span(img(src = 'AK_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                              div(span(img(src = 'AK_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                              div(span(img(src = 'AK_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                              div(span(img(src = 'AK_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                            )
                                                 ),
                            ...
                            tabPanel("Juneau",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Juneau_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Juneau_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Juneau_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Juneau_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Juneau_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Juneau_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Juneau_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Juneau_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Juneau_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Juneau_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                          ),
                            ...
                            tabPanel("Fairbanks",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Fairbanks_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Fairbanks_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Fairbanks_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Fairbanks_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Fairbanks_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Fairbanks_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Fairbanks_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Fairbanks_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Fairbanks_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Fairbanks_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                              ),
                            ...
                            tabPanel("Kodiak",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          ...
                                                          fluidPage(
                                                            div(span(img(src = 'Kodiak_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Kodiak_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Kodiak_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Kodiak_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Kodiak_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Kodiak_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Kodiak_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Kodiak_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Kodiak_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Kodiak_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                              ),
                 ...
                 navbarMenu("California",
                            tabPanel("State trends",
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'CA_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'CA_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'CA_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'CA_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'CA_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'CA_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'CA_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'CA_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'CA_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'CA_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                          ),
                            ...
                            tabPanel("Los Angeles",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Los_Angeles_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Los_Angeles_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Los_Angeles_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Los_Angeles_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Los_Angeles_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Los_Angeles_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Los_Angeles_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Los_Angeles_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Los_Angeles_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Los_Angeles_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                          ),
                            ...
                            tabPanel("Sacramento",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Sacramento_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Sacramento_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Sacramento_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Sacramento_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Sacramento_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Sacramento_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Sacramento_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Sacramento_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Sacramento_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Sacramento_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                            ...
                            tabPanel("Berkeley",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Berkeley_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Berkeley_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Berkeley_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Berkeley_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Berkeley_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Berkeley_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Berkeley_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Berkeley_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Berkeley_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Berkeley_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                          ),
                 ...
                 navbarMenu("Massachusetts",
                            ...
                            tabPanel("State trends",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'MA_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'MA_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'MA_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'MA_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'MA_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'MA_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'MA_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'MA_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'MA_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'MA_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                          ),
                            ...
                            tabPanel("Boston",
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Boston_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Boston_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Boston_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Boston_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Boston_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Boston_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Boston_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Boston_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Boston_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Boston_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                          ),
                                                 tabPanel("Word Frequency",
                                                          fluidPage(
                            ...
                            tabPanel("Brockton",
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Brockton_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Brockton_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Brockton_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Brockton_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Brockton_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Brockton_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Brockton_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Brockton_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Brockton_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Brockton_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                          ),
                                                 tabPanel("Word Frequency",
                                                          fluidPage(
                            ...
                            tabPanel("Worcester",
                                     ...
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Worcester_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Worcester_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Worcester_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Worcester_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Worcester_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Worcester_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Worcester_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Worcester_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Worcester_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Worcester_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                                                          ),
                 ...
                 navbarMenu("Texas",
                            tabPanel("State trends",
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'TX_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'TX_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'TX_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'TX_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'TX_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'TX_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'TX_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'TX_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'TX_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'TX_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                            ...
                            tabPanel("Dallas",
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Dallas_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Dallas_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Dallas_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Dallas_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Dallas_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Dallas_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Dallas_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Dallas_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Dallas_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Dallas_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                            ...
                            tabPanel("Houston",
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'Houston_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Houston_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Houston_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Houston_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Houston_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Houston_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'Houston_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Houston_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Houston_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'Houston_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
                            ...
                            tabPanel("San Antonio",
                                     tabsetPanel(type = "tabs",
                                                 ...
                                                 tabPanel("Seasonality",
                                                          fluidPage(
                                                            div(span(img(src = 'San_Antonio_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'San_Antonio_Spring_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'San_Antonio_Summer_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'San_Antonio_Fall_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'San_Antonio_Winter_dailymax.png', align='left', height = '400px', width = '600px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'San_Antonio_Overall_dailymax.png', align='left', height = '700px', width = '1100px'))),
                                                            br(), br(),
                                                            div(span(img(src = 'San_Antonio_Spring_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'San_Antonio_Summer_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'San_Antonio_Fall_dailymin.png', align='left', height = '400px', width = '600px'))),
                                                            div(span(img(src = 'San_Antonio_Winter_dailymin.png', align='left', height = '400px', width = '600px')))
                                                          )
